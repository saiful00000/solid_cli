...
import 'package:solid_cli/src/command_runner.dart';
...
void main() {
  group('SolidCliCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late ProcessResult processResult;
    late SolidCliCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = SolidCliCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = SolidCliCommandRunner();
